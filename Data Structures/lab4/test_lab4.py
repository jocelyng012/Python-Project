...
class T4_left_rotation(unittest.TestCase):

    def test_tree_left_rotation(self):
        print("\n")
        tree = rb_tree()
        tree.insert(7)
        tree.insert(5)
...
class T5_colors_after_insertion(unittest.TestCase):
...
class T7_insert_color(unittest.TestCase):

    def test_tree_insert_color(self):
        print("\n")
        print("tree_insert")
        tree = rb_tree()
        tree.insert(12)
...
class T8_insert_color_and_delete(unittest.TestCase):

    def test_tree_insert_color_and_delete(self):
        print("\n")
        print("tree_insert")
        tree = rb_tree()
        tree.insert(12)
        ...
        tree_preorder = [node.data for node in tree.preorder()]
        tree_preorder_color = [node.color for node in tree.preorder()]
        self.assertEqual(tree_preorder, [15, 10, 6, 4, 9, 12, 25, 17, 20, 30, 40])
        self.assertEqual(tree_preorder_color, ['black', 'black', 'black', 'red', 'red', 'black', 'black', 'black', 'red', 'black', 'red'])
        print("\n")
